	...
	<meta name="viewport" content="width=device-width, initial-scale=1.0">
	  <meta http-equiv="X-UA-Compatible" content="IE=edge,chrome=1">
		...
		<style type="text/css">
		  ...
		  table#info-faktur{width: 100%;}
		  table#info-faktur thead th{font-size: 13px;border-bottom:1px solid #c2c6c9;border-top:1px solid #c2c6c9; }
		  table#info-faktur tbody{font-size: 12px;border-bottom:1px solid #c2c6c9;}
		  
		  table#cart{width: 100%;}
		  table#cart thead th{font-size: 13px;border-bottom:1px solid #c2c6c9;border-top:1px solid #c2c6c9; }
		  table#cart tbody{font-size: 12px;border-bottom:1px solid #c2c6c9;}
		  table#cart tfoot{font-size: 12px;border-bottom:1px solid #c2c6c9;}
									...
									<table border="0" cellpadding="30" cellspacing="0" width="100%">
									  <tr>
										<td align="center" valign="top" class="textContent">
										  <h1 style="color:#FFFFFF;line-height:100%;font-family:Helvetica,Arial,sans-serif;font-size:35px;font-weight:normal;margin-bottom:5px;text-align:center;"><?php echo (isset($mailTitle) ? $mailTitle : "Contoh Header"); ?></h1>
										  <h2 style="text-align:center;font-weight:normal;font-family:Helvetica,Arial,sans-serif;font-size:23px;margin-bottom:10px;color:#205478;line-height:135%;"><?php echo (isset($mailSubTitle) ? $mailSubTitle : "Contoh Sub Header"); ?></h2>
										  <div style="text-align:center;font-family:Helvetica,Arial,sans-serif;font-size:15px;margin-bottom:0;color:#FFFFFF;line-height:135%;"><?php echo ""; ?></div>
										</td>
									  </tr>
									</table>
									<!-- // CONTENT TABLE -->
										  ...
										  <table border="0" cellpadding="0" cellspacing="0" width="100%">
											<tr>
											  <td valign="top" class="textContent">
												...
												-->
												<h3 mc:edit="header" style="color:#5F5F5F;line-height:125%;font-family:Helvetica,Arial,sans-serif;font-size:20px;font-weight:normal;margin-top:0;margin-bottom:3px;text-align:left;">Daftar Pesanan</h3>
									  ...
									  <tr>
										<td align="left" valign="top" class="flexibleContainerBox" style="background-color:#5F5F5F;">
										  <table border="0" cellpadding="30" cellspacing="0" width="100%" style="max-width:100%;">
											<tr>
											  <td align="left" class="textContent">
												<h3 style="color:#FFFFFF;line-height:125%;font-family:Helvetica,Arial,sans-serif;font-size:20px;font-weight:normal;margin-top:0;margin-bottom:3px;text-align:left;">Info Pengiriman</h3>
									  ...
									  <table border="0" cellpadding="30" cellspacing="0" width="100%">
										<tr>
										  <td valign="top" bgcolor="#E1E1E1">
											...
											<div style="font-family:Helvetica,Arial,sans-serif;font-size:13px;color:#828282;text-align:center;line-height:120%;">
											  <div>Copyright &#169; 2017 <a href="http://www.charlesmudy.com/respmail/" target="_blank" style="text-decoration:none;color:#828282;"><span style="color:#828282;">Haesmatika Mailer</span></a>. All&nbsp;rights&nbsp;reserved.</div>
