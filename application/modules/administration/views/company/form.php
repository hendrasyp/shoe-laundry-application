...
<div class="col-sm-6">
	...
	<div class="form-group row">
		<label for="txtCode" class="col-sm-3 col-form-label">Branch Code</label>
		<div class="col-sm-9">
			<input <?=(!empty($data["initial"]) || (trim($data["initial"])!="")) ? "readonly='readonly'":""; ?> type="text" value="<?= $data["initial"]; ?>" class="form-control" name="txtCode"
				   id="txtCode"
    ...
    <div class="form-group row">
        ...
        <div class="col-sm-9">
			<input type="text" value="<?= html_escape($data["mapurl"]); ?>" class="form-control" name="txtGoogleMap"
				   id="txtGoogleMap"
